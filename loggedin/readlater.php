...
$rating = count_rating($row['id'], $connect);
 ...
 for($count=1; $count<=5; $count++)
 {
  ...
  $output .= '<li title="'.$count.'" id="'.$row['id'].'-'.$count.'" data-index="'.$count.'"  data-business_id="'.$row['id'].'" data-rating="'.$rating.'" class="rating" style="cursor:pointer; display:inline-block; float:top; '.$color.' font-size:16px;">&#9733;
 </li>';
 }
 $output .= '
 </ul>
 ...
 <label style="color:rgb(226, 226, 226);margin-left:400px;">'.$row["CATEGORY"].'</label><br>
