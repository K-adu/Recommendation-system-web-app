...
foreach($result as $row)
{
 ...
 <label style="color:rgb(226, 226, 226);padding-left:400px;">'.$row["CATEGORY"].'</label>
 <a href="readlatersent.php?title='.$name.'&author='.$name2.'" style="color:white;margin-left:400px;">Add TO MY BOOKLISTS</a><br><br><br><br>
 ';
}
echo $output;
