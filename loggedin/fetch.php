...
$query = "
SELECT * FROM table2  ORDER BY id ASC limit 0,500
";
...
foreach($result as $row)
{
 ...
 <a href="readlatersent.php?title='.$name.'&author='.$name2.'" style="color:white;margin-left:400px;">Add TO MY BOOKLISTS</a><br><br>
 ';
}
echo $output;
