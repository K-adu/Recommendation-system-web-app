...
$query = "
SELECT * FROM table2 where CATEGORYID='29'  ORDER BY id ASC limit 9,8
";
...
{
 $rating = countin_rated($row['id'], $connect);
 $color = '';
 ...
 <p style="color:rgb(226, 226, 226); margin-left:80px; font-size:12px;">'.$row["TITLE"].'</p>
 <p style="color:rgb(226, 226, 226);padding-left:80px;font-size:12px;">'.$row["AUTHOR"].'</p>
 <label style="color:rgb(226, 226, 226);padding-left:80px;font-size:12px;">'.$row["CATEGORY"].'</label></th>
 ';
}
echo $output;

function countin_rated($business_id, $connect)
{
 $output = 0;
